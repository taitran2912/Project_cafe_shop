...
(5, 'VanE', 'Đỗ Văn E', '123456', '0905000005', 'vane@gmail.com', 1, 'active');
...
CREATE TABLE `Address` (
  ...
  `AddressDefault` int(11) NOT NULL,
...
INSERT INTO `Address` (`ID`, `ID_Customer`, `Address`, `AddressDefault`, `Latitude`, `Longitude`) VALUES
(6, 1, '210 Cách Mạng Tháng 8, Phường 10, Quận 3, TP. Hồ Chí Minh', 1, 10.7764500, 106.6824500),
(7, 1, '32 Nguyễn Văn Cừ, Phường Cầu Kho, Quận 1, TP. Hồ Chí Minh', 0, 10.7572100, 106.6888500),
(8, 3, '88 Trần Hưng Đạo, Phường Cầu Ông Lãnh, Quận 1, TP. Hồ Chí Minh', 1, 10.7598400, 106.6966800),
(9, 4, '25 Lý Thường Kiệt, Phường 7, Quận Tân Bình, TP. Hồ Chí Minh', 1, 10.7944800, 106.6522100),
(10, 5, '9 Nguyễn Trãi, Phường 2, Quận 5, TP. Hồ Chí Minh', 1, 10.7579300, 106.6810700);
...
INSERT INTO `Branches` (`ID`, `Name`, `Address`, `Phone`, `Status`, `Latitude`, `Longitude`) VALUES
(1, 'Chi nhánh Quận 1', '123 Nguyễn Huệ, Quận 1, TP.HCM', '02838250001', 'active', 10.7765300, 106.7036200),
(2, 'Chi nhánh Quận 3', '45 Cách Mạng Tháng 8, Quận 3, TP.HCM', '02838250003', 'active', 10.7820100, 106.6853500),
(3, 'Chi nhánh Quận 7', '88 Nguyễn Thị Thập, Quận 7, TP.HCM', '02838250007', 'active', 10.7374700, 106.7302000),
(4, 'Chi nhánh Bình Thạnh', '12 Phan Đăng Lưu, Bình Thạnh, TP.HCM', '02838250005', 'active', 10.8050200, 106.7070300),
(5, 'Chi nhánh Thủ Đức', '56 Võ Văn Ngân, Thủ Đức, TP.HCM', '02838250009', 'active', 10.8493900, 106.7544800);
...
INSERT INTO `Staff` (`ID`, `ID_account`, `ID_brand`) VALUES
(1, 2, 1),
(2, 4, 2),
(3, 1, 3),
(6, 3, 4);
...
--
-- Đang đổ dữ liệu cho bảng `Table_Coffee`
--

INSERT INTO `Table_Coffee` (`ID`, `ID_Brach`, `No`) VALUES
(1, 4, 1),
(2, 4, 2),
(3, 4, 3);
...
--
ALTER TABLE `Address`
  ADD CONSTRAINT `address_ibfk_1` FOREIGN KEY (`ID_Customer`) REFERENCES `Customer_Profile` (`ID`);
