...
<head>
    ...
    <link rel="stylesheet" href="https://caffeshop.hieuthuocyentam.id.vn/public/css/styles.css">
    <?php if (isset($data['css'])): ?>
        <link rel="stylesheet" href="https://caffeshop.hieuthuocyentam.id.vn/public/css/<?= $data['css'] ?>">
    <?php endif; ?>
